...
% TODO: check reference mostafizi2019agent ----------------------
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{images/modello_base_milling_time.png}
  \label{fig:modello-base-millingtime}
  \caption{Effetto di $\sigma$ sui tempi di partenza con $\tau = 5$ minuti,
  in base al valore di $\sigma$ è possibile capire quando il 99\% degli agenti avrà iniziato ad evacuare.}
\end{figure}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{images/modello_base_velocità_pedoni.png}
